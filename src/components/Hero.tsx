...
export function Hero() {
  return (
    <section id="top" className="hero-section relative overflow-x-clip px-6 py-16 sm:py-20 md:py-28">
      <AnimatedSun />
      ...
      <div className="hero-inner relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-8 text-center sm:gap-10">
        <Logo className="hero-wordmark h-14 sm:h-16 md:h-20" />

        <div className="hero-heading-wrap relative w-full max-w-xl px-2 sm:max-w-2xl sm:pr-[5.5rem] md:max-w-3xl md:pr-[7rem] lg:max-w-4xl lg:px-4 lg:pr-4">
          ...
          <h1 className="hero-title font-heading text-3xl leading-tight font-semibold text-josun-blue sm:text-4xl md:text-5xl lg:text-6xl">
            We'd love to meet
